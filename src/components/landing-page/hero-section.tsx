...
const transitionVariants: { item?: Variants; components?: Variants } = {
  item: {
    hidden: {
      opacity: 0,
      filter: "blur(12px)",
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  Create, personalize, and deliver engaging newsletters with real-time insights and 
                  effortless publishing ~ all from one powerful dashboard.
                </TextEffect>
