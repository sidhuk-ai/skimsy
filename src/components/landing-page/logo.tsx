...
export const Logo = ({
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1200" className={cn("h-8 w-auto text-foreground", className)}>
    <path
      xmlns="http://www.w3.org/2000/svg"
      d="m60.783 964.362 27.18.884-27.18 25.995zm-1.975 1.451v26.785H33.54c8.617-8.733 16.88-17.81 25.268-26.785zm27.706 3.628 3.486 1.2-12.588 7.476zm-68.184 2.966h5.523l12.865 14.07-5.985 6.121H18.33v-20.19zm-1.974 1.23v5.837H10zm3.363 20.98h38.627l-10.768 29.435zm39.09 4.543v41.202l-12.588-6.877c4.197-11.443 8.388-22.88 12.587-34.325z"
      overflow="visible"
      style={{
        textIndent: 0,
        textTransform: "none",
      }}
      transform="matrix(13.5 0 0 13.5 -75 -12931.888)"
    />
  </svg>
  );
};
